...
public class TaskInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String taskDescription = "Полная формулировка задачи: Одним из доступных способов заранее подготовьте базу данных. База данных, содержащая менее 20 записей будет считаться отсутсвующей.\n" +
                ...
                "Выполнил: Захарчук Павел, группа ПО-11, лабораторная работа №10.";
