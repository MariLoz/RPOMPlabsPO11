...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        downloadButton.setOnClickListener(v -> {
            // Вместо проверки на идентификатор просто скачиваем файл
            new DownloadFile().execute("https://drive.google.com/uc?export=download&id=1i811xaEWpFxR6Ubf2An30klFMTqK4pU1");
        });
